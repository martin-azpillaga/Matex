...
\laboratory{ $ Bifurcation Theory $ }
{
	...
	\start
	{
		...
		\ifandonlyif x = 1 \logicOr x^2 -2x + 2-a = 0 \ifandonlyif x \in \{ 1, 1 \pm \sqrt{ a-1 }\}.
		\all{ a \in \R }[ a \leq 1 ]
		{
			\fixed( f_a ) = \set{ 1 }
		}.
		...
		\all{ a \in \R \setminus (1,3) }
		{
			1 $ repulsive $
		}.
		\all{ a \in \R }[ a > 1 ]
		{
			\abs{ \partialderivative{ f }{ x }(a, 1 \pm \sqrt{ a-1 }) } = \abs{ 2a - 1 } > 1.
			1 \pm \sqrt{ a - 1 } $ repulsive $
		}.
		...
		\partialderivative{ f }{ a }(3,1) = 0 \imp \partialderivative{ f^2 }{ a }(3,1) = 0.
		\partialderivative{ f }{ x^2 }(3,1), \partialderivative{ f }{ x^2 }(3,f(3,1)) = 0 \imp \partialderivative{ f^2 }{ a }(3,1) = 0.
		\partialderivative{ f^2 }{ ax }(3,1) = 2 \neq 0.
		\partialderivative{ f^2 }{ x^3 }(3,1) = -12 \neq 0
	}
}}

\includepdf[pages=1-2]{../Tasks/scripts/script3}
