...
\laboratory{ $3rd laboratory$ }{ $ Bifurcation theory $ }
{
	\letbe
	{
	...
	\start
	{
		...
		$Stability:$.
		\partialderivative{ f_a }{ x }(x) = 3x^2 -6x + 5 - a.
		\partialderivative{ f_a }{ x^2 }(x) = 6x-6.
		\partialderivative{ f_a }{ x^3 }(x) = 6.
		\abs{\partialderivative{ f_a }{ x }(1)}< 1 \ifandonlyif \abs{ 2-a } < 1 \ifandonlyif a \in (1,3).
		\partialderivative{ f_1 }{ x^2 }(1) = 0, \partialderivative{ f_1 }{ x^3 }(1) > 0.
		\partialderivative{ f_3 }{ x^2 }(1) = 0, \partialderivative{ f_3 }{ x^3 }(1) > 0.
		...
		\all{ a \in \R }[ a > 1 ]
		{
			\abs{ \partialderivative{ f_a }{ x }(\pm \sqrt{ a-1 }) } = \abs{ 2a - 1 } > 1.
		...
		\partialderivative{ f^2 }{ x^2 }(3,1) = \partialderivative{ f }{ a }( f(3,1) )\partialderivative{ f }{ a }(3,1) = 0.
		\partialderivative{ f^2 }{ ax }(3,1) = \partialderivative{ f }{ ax }( f(3,1) )\partialderivative{ f }{ a }(3,1) \neq 0.
